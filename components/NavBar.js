...
const links = [
  {
    ...
    icon: <svg width="20" height="20" viewBox="0 0 24 24" fill="none"><path d="M3 12L12 3l9 9" stroke="currentColor" strokeWidth="1.7" strokeLinecap="round" strokeLinejoin="round"/><path d="M9 21V12h6v9" stroke="currentColor" strokeWidth="1.7" strokeLinecap="round" strokeLinejoin="round"/></svg>,
    c1: '#a050ff', c2: '#00dc82',
  },
  {
  ...
  },
  {
    ...
    icon: <svg width="20" height="20" viewBox="0 0 24 24" fill="none"><line x1="8" y1="6" x2="21" y2="6" stroke="currentColor" strokeWidth="1.7" strokeLinecap="round"/><line x1="8" y1="12" x2="21" y2="12" stroke="currentColor" strokeWidth="1.7" strokeLinecap="round"/><line x1="8" y1="18" x2="21" y2="18" stroke="currentColor" strokeWidth="1.7" strokeLinecap="round"/><circle cx="4" cy="6" r="1.3" fill="currentColor"/><circle cx="4" cy="12" r="1.3" fill="currentColor"/><circle cx="4" cy="18" r="1.3" fill="currentColor"/></svg>,
    c1: '#34d399', c2: '#a3e635',
  },
  {
    href: '/finanze', label: 'Finanze',
    icon: <svg width="20" height="20" viewBox="0 0 24 24" fill="none"><path d="M12 2v20M17 5H9.5a3.5 3.5 0 000 7h5a3.5 3.5 0 010 7H6" stroke="currentColor" strokeWidth="1.7" strokeLinecap="round"/></svg>,
    c1: '#60a5fa', c2: '#00dc82',
  },
  {
    href: '/spese-casa', label: 'Casa',
    icon: <svg width="20" height="20" viewBox="0 0 24 24" fill="none"><path d="M3 12L12 3l9 9v9a1 1 0 01-1 1H5a1 1 0 01-1-1v-9z" stroke="currentColor" strokeWidth="1.7" strokeLinejoin="round"/><path d="M9 21v-8h6v8" stroke="currentColor" strokeWidth="1.7" strokeLinecap="round"/></svg>,
    c1: '#38bdf8', c2: '#60a5fa',
  },
  {
    href: '/vestiti-ed-altro', label: 'Vestiti',
    icon: <svg width="20" height="20" viewBox="0 0 24 24" fill="none"><path d="M20 7l-4-4s-1 2-4 2-4-2-4-2L4 7l3 3v11h10V10l3-3z" stroke="currentColor" strokeWidth="1.7" strokeLinejoin="round"/></svg>,
    c1: '#f472b6', c2: '#fb7185',
  },
  {
    href: '/cene-aperitivi', label: 'Cene',
    icon: <svg width="20" height="20" viewBox="0 0 24 24" fill="none"><path d="M18 8h1a4 4 0 010 8h-1" stroke="currentColor" strokeWidth="1.7" strokeLinecap="round"/><path d="M2 8h16v9a4 4 0 01-4 4H6a4 4 0 01-4-4V8z" stroke="currentColor" strokeWidth="1.7" strokeLinejoin="round"/><line x1="6" y1="2" x2="6" y2="4" stroke="currentColor" strokeWidth="1.7" strokeLinecap="round"/><line x1="10" y1="2" x2="10" y2="4" stroke="currentColor" strokeWidth="1.7" strokeLinecap="round"/><line x1="14" y1="2" x2="14" y2="4" stroke="currentColor" strokeWidth="1.7" strokeLinecap="round"/></svg>,
    c1: '#f59e0b', c2: '#fb923c',
  },
  {
    href: '/varie', label: 'Varie',
    icon: <svg width="20" height="20" viewBox="0 0 24 24" fill="none"><circle cx="12" cy="12" r="3" stroke="currentColor" strokeWidth="1.7"/><path d="M12 2v2M12 20v2M4.22 4.22l1.42 1.42M18.36 18.36l1.42 1.42M2 12h2M20 12h2M4.22 19.78l1.42-1.42M18.36 5.64l1.42-1.42" stroke="currentColor" strokeWidth="1.7" strokeLinecap="round"/></svg>,
    c1: '#94a3b8', c2: '#d4d4d8',
  },
  {
    href: '/prodotti-tipici-vini', label: 'Vini',
    icon: <svg width="20" height="20" viewBox="0 0 24 24" fill="none"><path d="M8 2h8l2 7a6 6 0 01-12 0l2-7z" stroke="currentColor" strokeWidth="1.7" strokeLinejoin="round"/><line x1="12" y1="15" x2="12" y2="21" stroke="currentColor" strokeWidth="1.7" strokeLinecap="round"/><line x1="9" y1="21" x2="15" y2="21" stroke="currentColor" strokeWidth="1.7" strokeLinecap="round"/></svg>,
    c1: '#a050ff', c2: '#00dc82',
  },
]
    ...
    <>
      ...
      <style jsx>{`
        ...
        .label {
          ...
          font-size: .45rem; font-weight: 400;
          letter-spacing: .12em; text-transform: uppercase;
          white-space: nowrap; line-height: 1;
          position: relative; z-index: 1;
        }

        /* Glow radiale sotto icona quando attivo */
        .link-glow {
          position: absolute; inset: 0; pointer-events: none;
          background: radial-gradient(ellipse 90% 70% at 50% 130%,
            color-mix(in srgb, var(--c1) 28%, transparent), transparent 70%);
        ...
        .link.is-active .nav-icon {
          filter: drop-shadow(0 0 5px var(--c1)) drop-shadow(0 0 2px var(--c2));
          color: var(--c1);
        }
        ...
        @keyframes labelShimmer {
          ...
          50%      { filter: brightness(1.45) drop-shadow(0 0 3px var(--c1)); }
        }

        /* ── Logout — posizionato in assoluto a destra ── */
        .logout-btn {
        ...
        .logout-btn:hover {
          ...
          box-shadow: 0 0 14px -5px rgba(239,68,68,.6);
        }
        .logout-label {
          font-family: 'Syne Mono', monospace;
        ...
        @media (max-width: 900px) {
          ...
          .logout-btn { padding: 8px 10px; right: 10px; }
        }
        @media (max-width: 640px) {
          /* Solo icone su mobile */
          .label, .logout-label { display: none; }
          .link { padding: 10px 9px; flex-direction: row; }
          .logout-btn { flex-direction: row; }
