          ...
          <div className="pricing141-section-title">
            ...
            <div className="pricing141-content">
              <h2 className="pricing141-text101 thq-heading-2">
                {props.heading1 ?? (
                  <Fragment>
                    <span className="pricing141-text176">Pricing plan</span>
                  </Fragment>
                )}
              </h2>
              ...
              <div className="pricing141-column1 thq-card">
                <div className="pricing141-price10">
                  <div className="pricing141-price11">
                    <p className="pricing141-text107 thq-body-large">
                      {props.plan1 ?? (
                        <Fragment>
                          <span className="pricing141-text202">Basic plan</span>
                        </Fragment>
                      )}
                    </p>
                  ...
                  <div className="pricing141-list1">
                    <div className="pricing141-list-item10">
                      ...
                      <span className="thq-body-small">
                        {props.plan1Feature1 ?? (
                          <Fragment>
                            <span className="pricing141-text156">
                              Feature 1 included
                            </span>
                          </Fragment>
                        )}
                ...
                <button className="pricing141-button14 thq-button-outline thq-button-animated">
                  <span className="thq-body-small">
                    {props.plan1Action ?? (
                      <Fragment>
                        <span className="pricing141-text187">Sign Up</span>
                      </Fragment>
                    )}
                  </span>
                </button>
                ...
                <div className="pricing141-price12">
                  <div className="pricing141-price13">
                    <p className="pricing141-text114 thq-body-large">
                      {props.plan2 ?? (
                        <Fragment>
                          <span className="pricing141-text201">
                            Business plan
                          </span>
                        </Fragment>
                      )}
                    ...
                    <h3 className="pricing141-text115 thq-heading-3">
                      {props.plan2Price ?? (
                        <Fragment>
                          <span className="pricing141-text198">
                            $19.99/month
                          </span>
                        </Fragment>
                      )}
                    ...
                    <p className="thq-body-large">
                      {props.plan2Yearly ?? (
                        <Fragment>
                          <span className="pricing141-text188">
                            or $299 yearly
                          </span>
                        </Fragment>
                      )}
                  ...
                  <div className="pricing141-list2">
                    <div className="pricing141-list-item13">
                      ...
                      <span className="thq-body-small">
                        {props.plan2Feature1 ?? (
                          <Fragment>
                            <span className="pricing141-text191">
                              Feature 1 included
                            </span>
                          </Fragment>
                        )}
              ...
              <div className="pricing141-column3 thq-card">
                <div className="pricing141-price14">
                  <div className="pricing141-price15">
                    ...
                    <p className="thq-body-large">
                      {props.plan3Yearly ?? (
                        <Fragment>
                          <span className="pricing141-text155">
                            or $499 yearly
                          </span>
                        </Fragment>
                      )}
                  ...
                  <div className="pricing141-list3">
                    ...
                    <div className="pricing141-list-item21">
                      ...
                      <span className="thq-body-small">
                        {props.plan3Feature5 ?? (
                          <Fragment>
                            <span className="pricing141-text157">
                              Feature text goes here
                            </span>
                          </Fragment>
                        )}
                ...
                <button className="pricing141-button16 thq-button-filled thq-button-animated">
                  <span className="thq-body-small">
                    {props.plan3Action ?? (
                      <Fragment>
                        <span className="pricing141-text183">Sign Up</span>
                      </Fragment>
                    )}
                  </span>
                </button>
              ...
              <div className="pricing141-column4 thq-card">
                <div className="pricing141-price16">
                  <div className="pricing141-price17">
                    <span className="pricing141-text131 thq-body-large">
                      {props.plan11 ?? (
                        <Fragment>
                          <span className="pricing141-text161">Basic plan</span>
                        </Fragment>
                      )}
                    </span>
                    <h3 className="pricing141-text132 thq-heading-3">
                      {props.plan1Price1 ?? (
                        <Fragment>
                          <span className="pricing141-text192">$200/yr</span>
                        </Fragment>
                      )}
                    </h3>
                ...
                <button className="pricing141-button17 thq-button-outline thq-button-animated">
                  <span className="thq-body-small">
                    {props.plan1Action1 ?? (
                      <Fragment>
                        <span className="pricing141-text164">Get started</span>
                      </Fragment>
                    )}
                  </span>
                </button>
              ...
              <div className="pricing141-column5 thq-card">
                <div className="pricing141-price18">
                  <div className="pricing141-price19">
                    ...
                    <h3 className="pricing141-text139 thq-heading-3">
                      {props.plan2Price1 ?? (
                        <Fragment>
                          <span className="pricing141-text172">$299/yr</span>
                        </Fragment>
                      )}
                    </h3>
                    <span className="thq-body-large">
                    ...
                    <div className="pricing141-list-item26">
                      ...
                      <span className="thq-body-small">
                        {props.plan2Feature21 ?? (
                          <Fragment>
                            <span className="pricing141-text179">
                              Feature text goes here
                            </span>
                          </Fragment>
                        )}
                ...
                <button className="pricing141-button18 thq-button-filled thq-button-animated">
                  <span className="thq-body-small">
                    {props.plan2Action1 ?? (
                      <Fragment>
                        <span className="pricing141-text180">Get started</span>
                      </Fragment>
                    )}
                  </span>
                </button>
              ...
              <div className="pricing141-column6 thq-card">
                <div className="pricing141-price20">
                  <div className="pricing141-price21">
                    ...
                    <h3 className="pricing141-text147 thq-heading-3">
                      {props.plan3Price1 ?? (
                        <Fragment>
                          <span className="pricing141-text203">$499/yr</span>
                        </Fragment>
                      )}
                    </h3>
                    <span className="thq-body-large">
                      {props.plan3Yearly1 ?? (
                        <Fragment>
                          <span className="pricing141-text193">
                            or $49 monthly
                          </span>
                        </Fragment>
                      )}
                    ...
                    <div className="pricing141-list-item30">
                      ...
                      <span className="thq-body-small">
                        {props.plan3Feature21 ?? (
                          <Fragment>
                            <span className="pricing141-text197">
                              Feature text goes here
                            </span>
                          </Fragment>
                        )}
                    ...
                    <div className="pricing141-list-item32">
                      ...
                      <span className="thq-body-small">
                        {props.plan3Feature41 ?? (
                          <Fragment>
                            <span className="pricing141-text162">
                              Feature text goes here
                            </span>
                          </Fragment>
                        )}
                ...
                <button className="pricing141-button19 thq-button-filled thq-button-animated">
                  <span className="thq-body-small">
                    {props.plan3Action1 ?? (
                      <Fragment>
                        <span className="pricing141-text177">Get started</span>
                      </Fragment>
                    )}
                  </span>
                </button>
