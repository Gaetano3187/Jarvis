          ...
          <div className="steps23-container2 thq-grid-2">
            <div className="steps23-section-header">
              ...
              <div className="steps23-actions">
                <button className="thq-button-filled thq-button-animated steps23-button">
            ...
            <div className="steps23-container3">
              <div className="steps23-container4 thq-card">
                <h2 className="thq-heading-2">
                  {props.step1Title ?? (
                    <Fragment>
                      <span className="steps23-text26">Step 1: Sign Up</span>
                    </Fragment>
                  )}
                </h2>
                  ...
                  {props.step3Description ?? (
                    <Fragment>
                      <span className="steps23-text28">
                        Begin using the platform to enhance your productivity
