      ...
      <div className="hero172-header78">
        <div className="hero172-column thq-section-padding thq-section-max-width">
          <div className="hero172-content1">
            <h1 className="hero172-text1 thq-heading-1">
              {props.heading1 ?? (
                <Fragment>
                  <span className="hero172-text5">Welcome to our Website!</span>
                </Fragment>
              )}
            </h1>
            <p className="hero172-text2 thq-body-large">
              {props.content1 ?? (
                <Fragment>
                  <span className="hero172-text7">
          ...
          <div className="hero172-actions">
            <button className="thq-button-filled hero172-button1">
              <span className="thq-body-small">
                {props.action1 ?? (
                  <Fragment>
                    <span className="hero172-text6">Explore Now</span>
                  </Fragment>
                )}
              </span>
            </button>
            <button className="thq-button-outline hero172-button2">
              <span className="thq-body-small">
                {props.action2 ?? (
                  <Fragment>
                    <span className="hero172-text8">Learn More</span>
                  </Fragment>
                )}
              </span>
            </button>
          ...
          <div className="hero172-row-container2 thq-mask-image-horizontal thq-animated-group-container-horizontal">
            <div className="thq-animated-group-horizontal-reverse">
              ...
              <img
                alt={props.image9Alt}
                src={props.image9Src}
                className="hero172-placeholder-image24 thq-img-scale thq-img-ratio-1-1"
              />
              <img
                alt={props.image10Alt}
                src={props.image10Src}
                className="hero172-placeholder-image25 thq-img-scale thq-img-ratio-1-1"
              />
              <img
                alt={props.image11Alt}
                src={props.image11Src}
                className="hero172-placeholder-image26 thq-img-scale thq-img-ratio-1-1"
              />
              <img
                alt={props.image12Alt}
                src={props.image12Src}
                className="hero172-placeholder-image27 thq-img-scale thq-img-ratio-1-1"
              />
            </div>
            <div className="thq-animated-group-horizontal-reverse">
              <img
                alt={props.image7Alt}
                src={props.image7Src}
                className="hero172-placeholder-image28 thq-img-scale thq-img-ratio-1-1"
              />
              <img
                alt={props.image8Alt}
                src={props.image8Src}
                className="hero172-placeholder-image29 thq-img-scale thq-img-ratio-1-1"
              />
              <img
                alt={props.image9Alt}
                src={props.image9Src}
                className="hero172-placeholder-image30 thq-img-scale thq-img-ratio-1-1"
              />
              <img
                alt={props.image10Alt}
                src={props.image10Src}
                className="hero172-placeholder-image31 thq-img-scale thq-img-ratio-1-1"
              />
              <img
                alt={props.image11Alt}
                src={props.image11Src}
                className="hero172-placeholder-image32 thq-img-scale thq-img-ratio-1-1"
              />
              <img
                alt="Hero Image"
                src="https://images.unsplash.com/photo-1568214379698-8aeb8c6c6ac8?ixid=M3w5MTMyMXwwfDF8c2VhcmNofDEyfHxncmFmaWN8ZW58MHx8fHwxNzE1Nzk0OTk5fDA&amp;ixlib=rb-4.0.3&amp;w=1500"
                className="hero172-placeholder-image33 thq-img-scale thq-img-ratio-1-1"
              />
            </div>
          </div>
        </div>
...
`}
      ...
      <style jsx>
        {`
          ...
          .hero172-row-container1 {
            width: 100%;
          }
          .hero172-placeholder-image10 {
            width: 400px;
            height: 400px;
          }
          .hero172-placeholder-image11 {
            width: 400px;
            height: 400px;
          }
          .hero172-placeholder-image12 {
            width: 400px;
            height: 400px;
          }
          .hero172-placeholder-image13 {
            width: 400px;
            height: 400px;
          }
          .hero172-placeholder-image14 {
            width: 400px;
            height: 400px;
          }
          .hero172-placeholder-image15 {
            width: 400px;
            height: 400px;
          }
          .hero172-placeholder-image16 {
            width: 400px;
            height: 400px;
          }
          .hero172-placeholder-image17 {
            width: 400px;
            height: 400px;
          }
          .hero172-placeholder-image18 {
            width: 400px;
            height: 400px;
          }
          .hero172-placeholder-image19 {
            width: 400px;
            height: 400px;
          }
          .hero172-placeholder-image20 {
            width: 400px;
            height: 400px;
          }
          .hero172-placeholder-image21 {
            width: 400px;
            height: 400px;
          }
          .hero172-row-container2 {
            width: 100%;
          }
          .hero172-placeholder-image22 {
            width: 400px;
            height: 400px;
          }
          .hero172-placeholder-image23 {
            width: 400px;
            height: 400px;
          }
          .hero172-placeholder-image24 {
            width: 400px;
            height: 400px;
          }
          .hero172-placeholder-image25 {
            width: 400px;
            height: 400px;
          }
          .hero172-placeholder-image26 {
            width: 400px;
            height: 400px;
          }
          .hero172-placeholder-image27 {
            width: 400px;
            height: 400px;
          }
          .hero172-placeholder-image28 {
            width: 400px;
            height: 400px;
          }
          .hero172-placeholder-image29 {
            width: 400px;
            height: 400px;
          }
          .hero172-placeholder-image30 {
            width: 400px;
            height: 400px;
          }
          .hero172-placeholder-image31 {
            width: 400px;
            height: 400px;
          }
          .hero172-placeholder-image32 {
            width: 400px;
            height: 400px;
          }
          .hero172-placeholder-image33 {
            width: 400px;
            height: 400px;
          }
          .hero172-container2 {
