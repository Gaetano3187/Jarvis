  ...
  return (
    <>
      <div className="hero171-header78">
              ...
              {props.content1 ?? (
                <Fragment>
                  <span className="hero171-text8">
                    Explore a wide range of high-quality products that will meet
                    all your needs.
                  </span>
                </Fragment>
              )}
          ...
          <div className="hero171-actions">
            <button className="thq-button-filled hero171-button1">
              <span className="thq-body-small">
                {props.action1 ?? (
                  <Fragment>
                    <span className="hero171-text6">Shop Now</span>
                  </Fragment>
                )}
              </span>
            </button>
            <button className="thq-button-outline hero171-button2">
              <span className="thq-body-small">
                {props.action2 ?? (
                  <Fragment>
                    <span className="hero171-text7">Learn More</span>
                  </Fragment>
                )}
              </span>
            </button>
        ...
        <div className="hero171-content2">
          <div className="hero171-row-container1 thq-mask-image-horizontal thq-animated-group-container-horizontal">
          ...
          <div className="hero171-row-container2 thq-mask-image-horizontal thq-animated-group-container-horizontal">
            <div className="thq-animated-group-horizontal-reverse">
              ...
              <img
                alt={props.image9Alt}
                src={props.image9Src}
                className="hero171-placeholder-image24 thq-img-scale thq-img-ratio-1-1"
              />
              <img
                alt={props.image10Alt}
                src={props.image10Src}
                className="hero171-placeholder-image25 thq-img-scale thq-img-ratio-1-1"
              />
              <img
                alt={props.image11Alt}
                src={props.image11Src}
                className="hero171-placeholder-image26 thq-img-scale thq-img-ratio-1-1"
              />
              <img
                alt={props.image12Alt}
                src={props.image12Src}
                className="hero171-placeholder-image27 thq-img-scale thq-img-ratio-1-1"
              />
            </div>
            <div className="thq-animated-group-horizontal-reverse">
              <img
                alt={props.image7Alt}
                src={props.image7Src}
                className="hero171-placeholder-image28 thq-img-scale thq-img-ratio-1-1"
              />
              <img
                alt={props.image8Alt}
                src={props.image8Src}
                className="hero171-placeholder-image29 thq-img-scale thq-img-ratio-1-1"
              />
              <img
                alt={props.image9Alt}
                src={props.image9Src}
                className="hero171-placeholder-image30 thq-img-scale thq-img-ratio-1-1"
              />
              <img
                alt={props.image10Alt}
                src={props.image10Src}
                className="hero171-placeholder-image31 thq-img-scale thq-img-ratio-1-1"
              />
              <img
                alt={props.image11Alt}
                src={props.image11Src}
                className="hero171-placeholder-image32 thq-img-scale thq-img-ratio-1-1"
              />
              <img
                alt="Hero Image"
                src="https://images.unsplash.com/photo-1568214379698-8aeb8c6c6ac8?ixid=M3w5MTMyMXwwfDF8c2VhcmNofDEyfHxncmFmaWN8ZW58MHx8fHwxNzE1Nzk0OTk5fDA&amp;ixlib=rb-4.0.3&amp;w=1500"
                className="hero171-placeholder-image33 thq-img-scale thq-img-ratio-1-1"
              />
            </div>
          </div>
        </div>
...
`}
      ...
      <style jsx>
        {`
          ...
          .hero171-row-container2 {
            width: 100%;
          }
          .hero171-placeholder-image22 {
            width: 400px;
            height: 400px;
          }
          .hero171-placeholder-image23 {
            width: 400px;
            height: 400px;
          }
          .hero171-placeholder-image24 {
            width: 400px;
            height: 400px;
          }
          .hero171-placeholder-image25 {
            width: 400px;
            height: 400px;
          }
          .hero171-placeholder-image26 {
            width: 400px;
            height: 400px;
          }
          .hero171-placeholder-image27 {
            width: 400px;
            height: 400px;
          }
          .hero171-placeholder-image28 {
            width: 400px;
            height: 400px;
          }
          .hero171-placeholder-image29 {
            width: 400px;
            height: 400px;
          }
          .hero171-placeholder-image30 {
            width: 400px;
            height: 400px;
          }
          .hero171-placeholder-image31 {
            width: 400px;
            height: 400px;
          }
          .hero171-placeholder-image32 {
            width: 400px;
            height: 400px;
          }
          .hero171-placeholder-image33 {
            width: 400px;
            height: 400px;
          }
          .hero171-container2 {
...
Hero171.defaultProps = {
  image1Alt: 'Product Image 1',
  image12Alt: 'Product Image 12',
  image7Src:
  ...
  image6Alt: 'Product Image 6',
  image11Alt: 'Product Image 11',
  image9Src:
  ...
  image7Alt: 'Product Image 7',
  action1: undefined,
  image2Alt: 'Product Image 2',
  action2: undefined,
  image5Alt: 'Product Image 5',
  image3Src:
