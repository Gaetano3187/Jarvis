  ...
  return (
    <>
      <Head>
        ...
        .e-beam { position: absolute; left: 0; right: 0; height: 2px; background: linear-gradient(90deg, transparent, rgba(0,255,180,0.5), transparent); animation: eBeam 4s ease-in-out infinite; }
        @keyframes eBeam { 0% { top: -2px; opacity: 0; } 5% { opacity: 1; } 95% { opacity: .5; } 100% { top: 100%; opacity: 0; } }
        .scanlines { position: absolute; inset: 0; background: repeating-linear-gradient(0deg, transparent, transparent 2px, rgba(0,255,180,0.012) 2px, rgba(0,255,180,0.012) 4px); }
        .home-wrap { position: relative; z-index: 1; min-height: 100vh; display: flex; flex-direction: column; align-items: center; gap: 1rem; padding: 5rem 1rem 3rem; max-width: 480px; margin: 0 auto; font-family: 'Exo 2', sans-serif; }
        ...
        .logo-title { font-family: 'Orbitron', monospace; font-weight: 900; font-size: 58px; letter-spacing: 8px; background: linear-gradient(180deg, #ffffff 0%, #00ffb4 50%, #00b87a 100%); -webkit-background-clip: text; background-clip: text; color: transparent; line-height: .9; filter: drop-shadow(0 0 30px rgba(0,255,180,0.5)); animation: logoFlare 3s ease-in-out infinite; }
        @keyframes logoFlare { 0%,100% { filter: drop-shadow(0 0 20px rgba(0,255,180,0.35)); } 50% { filter: drop-shadow(0 0 55px rgba(0,255,180,0.75)) drop-shadow(0 0 100px rgba(0,255,180,0.25)); } }
        ...
        .orb { position: relative; width: 62px; height: 62px; border-radius: 50%; background: rgba(0,255,180,0.03); border: 1px solid rgba(0,255,180,0.2); display: flex; flex-direction: column; align-items: center; justify-content: center; gap: 4px; cursor: pointer; transition: all .22s; overflow: visible; }
        ...
        .orb-g { border-color: rgba(255,210,0,0.2); } .orb-g .p1 { border-color: rgba(255,210,0,0.32); } .orb-g .p2 { border-color: rgba(255,210,0,0.18); } .orb-g .p3 { border-color: rgba(255,210,0,0.1); } .orb-g .oi { color: rgba(255,210,0,0.52); } .orb-g .ol { color: rgba(255,210,0,0.3); } .orb-g:hover { border-color: rgba(255,210,0,0.65); background: rgba(255,210,0,0.06); box-shadow: 0 0 28px rgba(255,210,0,0.25); } .orb-g:hover .oi { color: rgba(255,210,0,1); filter: drop-shadow(0 0 7px rgba(255,210,0,0.9)); } .orb-g:hover .ol { color: rgba(255,210,0,0.85); }
        .orb-rec { border-color: rgba(255,60,60,0.6) !important; background: rgba(255,30,30,0.08) !important; box-shadow: 0 0 28px rgba(255,60,60,0.4) !important; } .orb-rec .p1 { border-color: rgba(255,60,60,0.55) !important; animation-duration: 1.2s !important; } .orb-rec .oi { color: #ff4d4d !important; } .orb-rec .ol { color: rgba(255,77,77,0.7) !important; }
        ...
        .ring-val { font-family: 'Orbitron', monospace; font-weight: 700; font-size: 20px; letter-spacing: 1px; color: #00ffb4; line-height: 1; text-shadow: 0 0 20px rgba(0,255,180,0.9), 0 0 40px rgba(0,255,180,0.4); animation: valGlow 2.5s ease-in-out infinite; }
        @keyframes valGlow { 0%,100% { text-shadow: 0 0 14px rgba(0,255,180,0.7), 0 0 28px rgba(0,255,180,0.3); } 50% { text-shadow: 0 0 28px rgba(0,255,180,1), 0 0 55px rgba(0,255,180,0.5), 0 0 80px rgba(0,255,180,0.15); } }
        ...
        .row-buy { border-left: 2px solid rgba(0,255,180,0.4); } .row-alert { border-left: 2px solid rgba(255,77,77,0.4); }
        .lista-name { color: rgba(190,240,220,0.85); font-size: 12px; } .lista-tag { font-size: 10px; color: rgba(0,255,180,0.5); background: rgba(0,255,180,0.06); border: 1px solid rgba(0,255,180,0.15); border-radius: 3px; padding: .1rem .4rem; }
        ...
        .jt-header { width: 100%; display: flex; align-items: center; justify-content: space-between; padding: 9px 14px; background: rgba(0,255,180,0.03); border: 1px solid rgba(0,255,180,0.13); border-radius: 12px 12px 0 0; border-bottom: none; }
        .jt-left { display: flex; align-items: center; gap: 9px; }
        .jt-icon { width: 30px; height: 30px; border-radius: 8px; background: rgba(0,255,180,0.07); border: 1px solid rgba(0,255,180,0.3); display: flex; align-items: center; justify-content: center; box-shadow: 0 0 10px rgba(0,255,180,0.12); animation: jtiPulse 2.5s ease-in-out infinite; }
        ...
        .jt-title { font-family: 'Orbitron', monospace; font-weight: 700; font-size: 13px; letter-spacing: .12em; background: linear-gradient(90deg, #ffffff, #00ffb4); -webkit-background-clip: text; background-clip: text; color: transparent; filter: drop-shadow(0 0 8px rgba(0,255,180,0.4)); }
        .jt-sub { font-family: 'Space Mono', monospace; font-size: 7px; letter-spacing: .06em; color: rgba(0,255,180,0.32); margin-top: 1px; }
        .jt-toggle { width: 28px; height: 28px; border-radius: 6px; background: rgba(0,255,180,0.04); border: 1px solid rgba(0,255,180,0.15); display: flex; align-items: center; justify-content: center; cursor: pointer; color: rgba(0,255,180,0.45); transition: all .18s; }
        ...
        .chat-messages::-webkit-scrollbar { width: 2px; } .chat-messages::-webkit-scrollbar-thumb { background: rgba(0,255,180,0.2); border-radius: 1px; }
        .chat-msg { display: flex; align-items: flex-start; gap: 7px; } .msg-ai { flex-direction: row; } .msg-user { flex-direction: row-reverse; }
        ...
        .conf-hi { background: rgba(0,255,180,0.1); color: #00dc82; border: 1px solid rgba(0,255,180,0.25); } .conf-md { background: rgba(215,175,0,.1); color: #dcc800; border: 1px solid rgba(215,175,0,.25); } .conf-lo { background: rgba(239,68,68,.1); color: #f87171; border: 1px solid rgba(239,68,68,.25); }
        ...
        .ocr-row span { color: rgba(0,255,180,0.4); } .ocr-row strong { color: rgba(190,240,220,0.9); }
        ...
        .ocr-save:hover { background: rgba(0,255,180,0.16); box-shadow: 0 0 14px rgba(0,255,180,0.25); } .ocr-save:disabled { opacity: .45; cursor: not-allowed; }
        ...
        .sf-tl { top: 0; left: 0; border-top: 2px solid rgba(0,255,180,0.8); border-left: 2px solid rgba(0,255,180,0.8); } .sf-tr { top: 0; right: 0; border-top: 2px solid rgba(0,255,180,0.8); border-right: 2px solid rgba(0,255,180,0.8); } .sf-bl { bottom: 0; left: 0; border-bottom: 2px solid rgba(0,255,180,0.8); border-left: 2px solid rgba(0,255,180,0.8); } .sf-br { bottom: 0; right: 0; border-bottom: 2px solid rgba(0,255,180,0.8); border-right: 2px solid rgba(0,255,180,0.8); }
        ...
        @media (max-width: 480px) { .logo-title { font-size: 46px; } .cmd-zone { gap: 7px; } .orb { width: 56px; height: 56px; } .home-wrap { padding: 3.5rem .75rem 2.5rem; } }`}}/>
      </Head>
