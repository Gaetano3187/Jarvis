...
/** Rileva se il testo specifica esplicitamente la struttura "confezioni da X" */
  ...
  try {
    ...
    if (updates.length === 0 && !looksExpiry) {
      try {
        ...
        if (DEBUG) console.warn('[Assistant updates fallback error]', e);
      }
    }
...
<style jsx>{`
    ...
    /* Effetti hover generici per button */
    :global(button){
    ...
    /* Animazione scorte basse (mantengo la tua classe) */
    ...
    @keyframes pulseBloom {
      0%,100% { opacity:.32; filter:brightness(1); }
      50%     { opacity:.78; filter:brightness(1.25); }
    }
  `}</style>
</>
        </div>
...
const styles = {
  ...
  homeBtn: {
    position: 'relative',
    background: 'linear-gradient(180deg, rgba(99,102,241,0.98), rgba(99,102,241,0.84))',
    ...
    textDecoration: 'none',
    fontWeight: 800,
    boxShadow: '0 8px 20px rgba(0,0,0,0.28), inset 0 1px 0 rgba(255,255,255,0.06)',
  },
  ...
  switchBtn: {
    ...
    cursor: 'pointer',
    fontWeight: 700,
    boxShadow: '0 6px 18px rgba(0,0,0,0.26), inset 0 1px 0 rgba(255,255,255,0.05)',
  },
  switchBtnActive: {
    position: 'relative',
    background: 'linear-gradient(180deg, rgba(6,182,212,0.98), rgba(6,182,212,0.84))',
    border: '1px solid rgba(255,255,255,0.16)',
    color: '#0b1220',
    padding: '8px 12px',
    borderRadius: 12,
    cursor: 'pointer',
    fontWeight: 900,
    boxShadow: '0 10px 24px rgba(0,0,0,0.28), 0 0 28px rgba(6,182,212,0.24), inset 0 1px 0 rgba(255,255,255,0.06)',
  },
  ...
  qtyBadge: {
    ...
    height: 34,
    borderRadius: 12,
    background: 'linear-gradient(180deg, rgba(99,102,241,.30), rgba(99,102,241,.18))',
    display: 'flex',
    alignItems: 'center',
    justifyContent: 'center',
    fontWeight: 900,
    border: '1px solid rgba(255,255,255,0.14)',
    boxShadow: '0 6px 16px rgba(0,0,0,.28), inset 0 1px 0 rgba(255,255,255,0.06)',
  },
  ...
  actionSuccess: {
    position: 'relative',
    background: 'linear-gradient(180deg, rgba(22,163,74,0.98), rgba(22,163,74,0.82))',
    border: '1px solid rgba(255,255,255,0.16)',
    color: '#fff',
    padding: '8px 10px',
    borderRadius: 12,
    cursor: 'pointer',
    fontWeight: 800,
    boxShadow: '0 10px 24px rgba(0,0,0,0.28), 0 0 28px rgba(22,163,74,0.26), inset 0 1px 0 rgba(255,255,255,0.06)',
  },
  actionDanger: {
    position: 'relative',
    background: 'linear-gradient(180deg, rgba(239,68,68,0.98), rgba(239,68,68,0.84))',
    border: '1px solid rgba(255,255,255,0.16)',
    color: '#fff',
    padding: '8px 10px',
    borderRadius: 12,
    cursor: 'pointer',
    fontWeight: 800,
    boxShadow: '0 10px 24px rgba(0,0,0,0.28), 0 0 28px rgba(239,68,68,0.28), inset 0 1px 0 rgba(255,255,255,0.06)',
  },
  actionGhost: {
    position: 'relative',
    ...
    cursor: 'pointer',
    fontWeight: 700,
    boxShadow: '0 8px 20px rgba(0,0,0,0.26), inset 0 1px 0 rgba(255,255,255,0.05)',
  },
  actionGhostDanger: {
    position: 'relative',
    ...
    cursor: 'pointer',
    fontWeight: 700,
    boxShadow: '0 8px 20px rgba(0,0,0,0.26), inset 0 1px 0 rgba(255,255,255,0.04)',
  },
  ...
  primaryBtn: {
    position: 'relative',
    background: 'linear-gradient(180deg, rgba(22,163,74,0.98), rgba(22,163,74,0.84))',
    border: '1px solid rgba(255,255,255,0.16)',
    color: '#fff',
    padding: '10px 12px',
    borderRadius: 12,
  ...
  voiceBtnSmall: {
    ...
    cursor: 'pointer',
    fontWeight: 700,
    boxShadow: '0 6px 18px rgba(0,0,0,0.28), inset 0 1px 0 rgba(255,255,255,0.06)',
  },
  voiceBtnSmallStop: {
    position: 'relative',
    background: 'linear-gradient(180deg, rgba(239,68,68,0.95), rgba(239,68,68,0.80))',
    border: '1px solid rgba(255,255,255,0.16)',
    color: '#fff',
    padding: '8px 12px',
    borderRadius: 10,
  ...
  ocrBtnSmall: {
    position: 'relative',
    background: 'linear-gradient(180deg, rgba(6,182,212,0.95), rgba(6,182,212,0.78))',
    border: '1px solid rgba(255,255,255,0.16)',
    color: '#0b1220',
    padding: '8px 12px',
    borderRadius: 10,
  ...
  ocrInlineBtn: {
    position: 'relative',
    background: 'linear-gradient(180deg, rgba(6,182,212,.22), rgba(6,182,212,.12))',
