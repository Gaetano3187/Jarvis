...
/* ---------------- styles (coerenti con /home: pannelli, glow, bordi, sheen) ---------------- */
const styles = {
  page: {
    width: '100%',
    minHeight: '100vh',
  ...
  card: {
    width: '100%',
    maxWidth: 1100,
    background: 'linear-gradient(180deg, rgba(0,0,0,.62), rgba(0,0,0,.46))',
    borderRadius: 18,
    padding: 22,
  ...
  // Riflesso sheen: usa className="sheen" sul container che vuoi “lucidare”
  sheen: {
    position: 'relative',
    overflow: 'hidden',
  },
