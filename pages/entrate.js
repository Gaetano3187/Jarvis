...
function Entrate() {
  ...
  async function loadAll() {
    ...
    try {
      ...
      // 4) Raggruppo scontrini (cliccabili) da jarvis_spese_casa
  ...
  return (
    <>
            ...
            <div className="table-wrap">
              <table className="custom-table">
                ...
                <tbody>
                  ...
                  {pocketRows.length === 0 && <tr><td colSpan={3} style={{opacity:.8}}>Nessuna riga.</td></tr>}
                </tbody>
              </table>
            </div>
          )}
      ...
      <style jsx global>{`
        ...
        .btn-manuale:hover, .btn-vocale:hover, .btn-ocr:hover { transform: translateY(-1px); opacity: .95; }
