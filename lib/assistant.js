 ...
 */
export async function parseAssistant(data, assistantType = 'STT') {
  const prompt = typeof data === 'string' ? data : JSON.stringify(data);
  return askAssistant(prompt, {}, assistantType);
}
/**
